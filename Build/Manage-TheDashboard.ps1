...
Invoke-ModuleBuild -ModuleName 'TheDashboard' {
    ...
    New-ConfigurationModule -Type RequiredModule -Name 'PSSharedGoods', 'PSWriteHTML' -Guid Auto -Version Latest
    ...
    # import self to make sure that all functions are available
